    ...
    <?php if ($getCart != NULL) { ?>
        <div class="container">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                    foreach ($getCartDetail as $value) {
                    ?>
                        <tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Rp <?= number_format($getCart['total_price'], 0, ',', '.'); ?></td>
                    </tr>
                </tbody>
            </table>
            <div class="text-center">
                <a href="<?= base_url('dashboard/checkoutProduct/') . $getCart['id'] ?>" class="btn btn-dark"><i class="fas fa-shopping-cart"></i> Checkout</a>
            </div>
        </div>
    <?php } else { ?>
